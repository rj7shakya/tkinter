...
def popupwin():
    ...
    Button(top, text="Insert", command=lambda: insert_val(
...
# Create a Label
label = Label(win, text="Click the Button to Open the Popup Dialogue",
              font=('Helvetica 15 bold'))
label.pack(pady=20)

# Create a Button
button = Button(win, text="Click Me!", command=popupwin,
